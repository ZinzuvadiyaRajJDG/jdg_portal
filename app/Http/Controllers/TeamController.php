...
class TeamController extends Controller
{
     ...
     */
     ...
     {
          $this->middleware('permission:manage-team|team-create|team-edit|team-show', ['only' => ['index','show']]);
    ...
    public function index(Request $request): View
    {
        ...
        $query = User::role(['Management Team']);
    ...
    public function create(): View
    {
        ...
        foreach ($roles as $role) {
            $rolePermissions[$role] = Role::findByName($role)->permissions->pluck('id')->toArray();
        }
        return view('teams.create',compact('roles','permissions', 'rolePermissions'));
    }
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        if($request->input('roles') != "Admin")
        {
            ...
            $attendance_create->status = 'present';
    ...
    public function show($id): View
    {
        ...
        return view('teams.show',compact('user','salary','paid_leave','leave_in_yare'));
    }
    ...
    //     return view('teams.edit',compact('user','roles','userRole'));
    // }
    ...
    public function edit($id): View
    {
        ...
        return view('teams.edit', compact('user', 'roles', 'permissions', 'userRoles', 'userPermissions', 'rolePermissions'));
    }
    ...
    public function changeStatus($id)
    {
        ...
        return redirect('teams')->with('success', 'Team Status updated successfully.');
