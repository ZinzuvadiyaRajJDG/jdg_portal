                ...
                {{-- @if ($existingAttendance && $existingAttendance->clock_out)
                    <div class="intro-y box p-5">
                        <div class="custom-success-message">
                            <strong>Success:</strong> You have successfully clocked out for today.
                        </div>
                    </div>
                @else --}}
                    ...
                    <div class="intro-y col-span-12 md:col-span-6">
                        ...
                        @endif
                            ...
                            <div id="basic-datepicker" class="pb-5">
                                <div class="preview">
                                    <input class="datepicker form-control w-full  block " id="date-input" name="date" data-single-mode="true" disabled>
                                </div>
                            ...
                            <div id="basic-datepicker" class="">
                                <div class="preview">
                                    <input id="clock-in-input" class=" form-control w-full  block " name="clock_in" data-single-mode="true" disabled>
                                </div>
                                @if ($clockInButton)
                                    <div id="message text-danger text-center" style="text-align:center; color:green;" class="mt-2">
                            ...
                            {{-- <div id="basic-datepicker" class="">
                                <div class="preview">
                                    <input id="clock-out-input" class="datepicker form-control w-56 block mx-auto" name="clock_out" data-single-mode="true" readonly>
                                </div>
                                <div id="message text-success text-center" style="text-align:center; color:green;" class="mt-2">
                                </div>
                                <div class="source-code hidden">
