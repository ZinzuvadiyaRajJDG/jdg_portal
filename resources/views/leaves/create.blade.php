                    ...
                    <div class="intro-y col-span-12 lg:col-span-6">
                        ...
                        <div class="intro-y box p-5">
                            ...
                            <div class="mt-3">
                                ...
                                <input id="crud-form-1" type="text" name="leave_heading" class="form-control w-full" placeholder="Leave Heading" value="{{ old('leave_heading') }}">
                                @error('leave_heading')
                            ...
                            <div class="mt-3">
                                <label for="crud-form-1" class="form-label">Leave Reason</label>
                                <textarea class="ckeditor form-control" name="leave_reason">{{ old('leave_reason') }}</textarea>
                                @error('leave_reason')
                                    <span class="error_msg">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="mt-3">
                                <label for="crud-form-1" class="form-label">Day</label><br>
                                    <input type="radio" id="half day" name="day" value="half day" {{ old('day') === 'half day' ? 'checked' : '' }}>
                                    <label for="html">Half Day</label><br>
                                    <input type="radio" id="full day" name="day" value="full day" {{ old('day') === 'full day' ? 'checked' : '' }}>
                                    <label for="css">Full Day</label><br>

                                    <input type="radio" id="medical leave" name="day" value="medical leave" {{ old('day') === 'medical leave' ? 'checked' : '' }}>
                                    <label for="css">Medical Leave</label><br>

                                    <input type="radio" id="emergency leave" name="day" value="emergency leave" {{ old('day') === 'emergency leave' ? 'checked' : '' }}>
                                    <label for="css">Emergency Leave</label><br>
                                    
                                    <input type="radio" id="paid holiday" name="day" value="paid holiday" {{ old('day') === 'paid holiday' ? 'checked' : '' }}>
                                    <label for="css">Paid Leave</label><br>
                                    <input type="radio" id="casual leave" name="day" value="casual leave" {{ old('day') === 'casual leave' ? 'checked' : '' }}>
                            ...
                            <div class="mt-3">
                                ...
                                <input id="num-of-days" type="number" name="total_day" class="form-control w-56 block" min="1" step="1" value="{{ old('total_day') }}">
                                @error('total_day')
                                    <span class="error_msg">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="mt-3">
                                ...
                                <div class="preview">
                                    <input class="datepicker form-control w-56 block" name="start_leave_date" data-single-mode="true" value="{{ old('start_leave_date') }}">
                            ...
                            <div class="mt-3">
                                ...
                                <div id="basic-datepicker" class="">
                                    <div class="preview">
                                        <input id="end-leave-date" class="datepicker form-control w-56 block" name="end_leave_date" data-single-mode="true" value="{{ old('end_leave_date') }}" >
                                    </div>
...
<script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            cancelButton.addEventListener('click', function() {
                ...
                window.location.href = 'https://team.justdigitalgurus.com/leaves';
            });
        });
    </script>
<script>
    $(document).ready(function () {
        function updateEndDateDisabledState() {
            ...
            if (selectedValue === 'half day' || selectedValue === 'full day') {
                ...
                $('#num-of-days').prop('required', false);
                $('#num-of-days').val(1);
            ...
            else 
            {
                ...
                // endLeaveDateInput.prop('disabled', false);
                $('#num-of-days').prop('required', true);
