...
@extends('layouts.app')
@section('content')
<h2 class="intro-y text-lg font-medium mt-10">Employee Information</h2>
                    ...
                    <div class="col-span-12 lg:col-span-12 xxl:col-span-6 flex lg:block flex-col-reverse">
                        <div class="intro-y box mt-5 lg:mt-0">
                            ...
                            <div class="p-5 border-t border-gray-200 dark:border-dark-5 flex">
                                ...
                                <a type="button" href="{{ route('users.edit', $user->id) }}" class="btn btn-outline-secondary py-1 px-2 ml-auto">Edit Profile</a>
                            </div>
                        </div>
                    </div>
                    <!-- END: Profile Menu -->
