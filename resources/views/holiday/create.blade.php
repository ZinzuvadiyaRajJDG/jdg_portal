        ...
        <div class="intro-y col-span-12 lg:col-span-6">
            ...
            <div class="intro-y box p-5">
                <div>
                    ...
                    <input id="crud-form-1" type="text" name="name" class="form-control w-full" placeholder="Enter Holiday Name" value="{{ old('name') }}">
                    @error('name')
                ...
                <div class="mt-3">
                    ...
                    <input id="day" type="number" name="day" class="form-control w-full block" min="1" step="1" value="{{ old('day') }}" placeholder="Enter Number of Day">
                    @error('day')
                        <span class="error_msg">{{ $message }}</span>
                    @enderror
                </div>      
                <div class="mt-3">
                    ...
                    <input id="crud-form-2" type="date" name="date" class="form-control w-full" placeholder="Enter Holiday Date" value="{{ old('date') }}">
                    @error('date')
                        <span class="error_msg">{{ $message }}</span>
                    @enderror
                </div>
                <div class="mt-3">
                    ...
                    <input id="end_date" type="date" name="end_date" class="form-control w-full" placeholder="Enter End Date" value="{{ old('end_date') }}">
                    @error('end_date')
                        <span class="error_msg">{{ $message }}</span>
                    @enderror
                </div>
