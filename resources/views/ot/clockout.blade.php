...
@section('content')
    ...
    <form method="POST" action="{{ url('overtime/clockout') }}">
        @csrf
        <div class="grid grid-cols-12 gap-6 mt-5">
            <div class="intro-y col-span-12 md:col-span-6">
                ...
                <div class="intro-y box p-5">
                    ...
                    @endif
                    <input id="crud-form-1" type="text" name="user_id" class="form-control w-full" placeholder=""
                        value="{{ $user->id }}" hidden>
                    <div id="basic-datepicker">
                        <div class="preview">
                            <input class="datepicker form-control w-full mx-auto" id="date-input" data-single-mode="true"
                                disabled>
                        </div>
                    ...
                    <div id="basic-datepicker" class="mt-5">
                        <div class="preview">
                            <input id="clock-out-input" type="text" class="form-control w-full mx-auto" name="clock_out"
